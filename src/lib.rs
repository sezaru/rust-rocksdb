...
pub use crate::{
    ...
    db_options::{
        AccessHint, BlockBasedIndexType, BlockBasedOptions, BottommostLevelCompaction, Cache,
        CompactOptions, DBCompactionStyle, DBCompressionType, DBPath, DBRecoveryMode,
